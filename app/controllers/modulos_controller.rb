class ModulosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @modulo.save
        format.html { redirect_to modulos_index_path, notice: 'Modulo was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @modulo.update(modulo_params)
        format.html { redirect_to  modulos_index_path, notice: 'Modulo was successfully updated.' }
  ...
  def destroy
    @modulo.destroy
    respond_to do |format|
      format.html { redirect_to  modulos_index_path, notice: 'Modulo was successfully destroyed.' }
  ...
  private
    ...
    def modulo_params
      params.require(:modulo).permit(:descricao, :user_id)
    end
end
