...
class PerfilsControllerTest < ActionController::TestCase
  ...
  test "should create perfil" do
    assert_difference('Perfil.count') do
      post :create, perfil: { descricao: @perfil.descricao, objetivo: @perfil.objetivo, profissao: @perfil.profissao, user_id: @perfil.user_id }
    end
  ...
  test "should update perfil" do
    patch :update, id: @perfil, perfil: { descricao: @perfil.descricao, objetivo: @perfil.objetivo, profissao: @perfil.profissao, user_id: @perfil.user_id }
    assert_redirected_to perfil_path(assigns(:perfil))
  end
